...
(function(){
  ...
  var html='<div id="ckb" role="dialog" aria-label="Использование файлов cookie">'+
    ...
    '<p>Технические cookie нужны для работы сайта. Аналитические и маркетинговые помогают нам понимать, какие страницы полезны, и оценивать рекламу. Вы можете принять все или оставить только необходимые. Подробнее — в <a href="/a/politika/">политике обработки данных</a>.</p>'+
